...
{
    public partial class FormPersonList : Form, IFormConfiguration
    {
        #region Конструктор.
        ...
        private bool RefreshList(out DataTable dataTable, out string message)
        {
            ...
            try
            {
                if (Config.Session.PersonUtils.GetTable(out dataTable, out message))
                {
                    result = true;
                }
            }
        ...
        private void bNView_Click(object sender, EventArgs e)
        {
            ...
            if (id.HasValue)
            {
                Person obj = Config.Session.PersonUtils.GetById(id.Value);

                FormPersonCard form = new FormPersonCard(obj, FormMode.View);
                form.ShowDialog();
        ...
        private void bNAdd_Click(object sender, EventArgs e)
        {
            ...
            FormPersonCard form = new FormPersonCard(obj, FormMode.Add);
            form.ShowDialog();
        ...
        private void bNEdit_Click(object sender, EventArgs e)
        {
            ...
            if (id.HasValue)
            {
                ...
                FormPersonCard form = new FormPersonCard(obj, FormMode.Edit);
                form.ShowDialog();
        ...
        private void bNDelete_Click(object sender, EventArgs e)
        {
            ...
            if (id.HasValue)
            {
                ...
                if (MessageBox.Show(this, "Вы действительно хотите удалить человека?", "Предупреждение", MessageBoxButtons.OKCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) == System.Windows.Forms.DialogResult.OK)
                {
                    Config.Session.PersonUtils.Delete(obj);
                    ApplyFilter();
                }
            }
        }
