...
{
    public partial class FormCityList : Form, IFormConfiguration
    {
        ...
        private bool RefreshList(out DataTable dataTable, out string message)
        {
            ...
            try
            {
                if (Config.Session.CityUtils.GetTable(out dataTable, out message))
                {
                    result = true;
                }
            }
        ...
        private void bNView_Click(object sender, EventArgs e)
        {
            ...
            if (id.HasValue)
            {
                City obj = Config.Session.CityUtils.GetById(id.Value);

                FormCityCard form = new FormCityCard(obj, FormMode.View);
                form.ShowDialog();
        ...
        private void bNAdd_Click(object sender, EventArgs e)
        {
            ...
            FormCityCard form = new FormCityCard(obj, FormMode.Add);
            form.ShowDialog();
        ...
        private void bNEdit_Click(object sender, EventArgs e)
        {
            ...
            if (id.HasValue)
            {
                ...
                FormCityCard form = new FormCityCard(obj, FormMode.Edit);
                form.ShowDialog();
        ...
        private void bNDelete_Click(object sender, EventArgs e)
        {
            ...
            if (id.HasValue)
            {
                ...
                if (MessageBox.Show(this, "Вы действительно хотите удалить город?", "Предупреждение", MessageBoxButtons.OKCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) == System.Windows.Forms.DialogResult.OK)
                {
                    Config.Session.CityUtils.Delete(obj);
                    ApplyFilter();
                }
            }
        }
