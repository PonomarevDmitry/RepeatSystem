...
{
    public partial class FormTagCard : Form, IFormConfiguration
    {
        private FormMode mode;

        public Tag ObjectTag { get; private set; }

        public bool IsObjectAddedIntoDataBase { get; private set; }

        public FormTagCard(Tag objectTag, FormMode mode)
        {
            InitializeComponent();
        ...
        private void SetFormMode()
        {
            ...
            tSMIEdit.Enabled = tSMIEdit.Visible = mode == FormMode.View && this.ObjectTag.Id.HasValue;

            if (this.mode == FormMode.Add)
            {
                if (this.ObjectTag.Id.HasValue)
                {
            ...
            {
                case FormMode.Add:
                    this.Text = "Добавление информации о тэге";
                    ActivateControls(true);
                    break;

                case FormMode.Edit:
                    this.Text = "Редактирование информации о тэге";
                    ActivateControls(true);
                    break;

                case FormMode.View:
                default:
                    this.Text = "Просмотр информации о тэге";
                    ActivateControls(false);
                    break;
            }
        ...
        private void LoadFieldsFromObject() 
        {
            ...
            {
                txtBName.Text = this.ObjectTag.Name;
        ...
        {
            this.ObjectTag.Name = txtBName.Text.Trim();
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (Config.Session.TagUtils.Save(this.ObjectTag, out message))
            {
