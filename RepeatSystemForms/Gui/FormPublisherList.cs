...
{
    public partial class FormPublisherList : Form, IFormConfiguration
    {
        ...
        public bool IsSelect
        {
            ...
            set
            {
                ...
                this.KeyDown += new KeyEventHandler(FormPublisherList_KeyDown);
            }
        }

        void FormPublisherList_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        public Publisher SelectedPublisher { get { return this.selectedPublisher; } }

        #region Конструктор.

        public FormPublisherList()
        {
            InitializeComponent();
        ...
        private bool RefreshList(out DataTable dataTable, out string message)
        {
            ...
            try
            {
                if (Config.Session.PublisherUtils.GetTable(out dataTable, out message))
                {
                    result = true;
                }
            }
        ...
        private void bNView_Click(object sender, EventArgs e)
        {
            ...
            if (id.HasValue)
            {
                Publisher obj = Config.Session.PublisherUtils.GetById(id.Value);

                FormPublisherCard form = new FormPublisherCard(obj, FormMode.View);
                form.ShowDialog();
        ...
        private void bNAdd_Click(object sender, EventArgs e)
        {
            ...
            FormPublisherCard form = new FormPublisherCard(obj, FormMode.Add);
            form.ShowDialog();
        ...
        private void bNEdit_Click(object sender, EventArgs e)
        {
            ...
            if (id.HasValue)
            {
                ...
                FormPublisherCard form = new FormPublisherCard(obj, FormMode.Edit);
                form.ShowDialog();
        ...
        private void bNDelete_Click(object sender, EventArgs e)
        {
            ...
            if (id.HasValue)
            {
                ...
                if (MessageBox.Show(this, "Вы действительно хотите удалить издательство?", "Предупреждение", MessageBoxButtons.OKCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) == System.Windows.Forms.DialogResult.OK)
                {
                    Config.Session.PublisherUtils.Delete(obj);
                    ApplyFilter();
                }
            }
        }
