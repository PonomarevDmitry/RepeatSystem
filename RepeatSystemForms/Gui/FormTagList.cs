...
{
    public partial class FormTagList : Form, IFormConfiguration
    {
        ...
        public bool IsSelect
        {
            ...
            set
            {
                ...
                this.KeyDown += new KeyEventHandler(FormTagList_KeyDown);
            }
        }

        void FormTagList_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        public Tag SelectedTag { get { return this.selectedTag; } }
        ...
        private bool RefreshList(out DataTable dataTable, out string message)
        {
            ...
            try
            {
                if (Config.Session.TagUtils.GetTable(out dataTable, out message))
                {
                    result = true;
                }
            }
        ...
        private void bNView_Click(object sender, EventArgs e)
        {
            ...
            if (id.HasValue)
            {
                Tag obj = Config.Session.TagUtils.GetById(id.Value);

                FormTagCard form = new FormTagCard(obj, FormMode.View);
                form.ShowDialog();
        ...
        private void bNAdd_Click(object sender, EventArgs e)
        {
            ...
            FormTagCard form = new FormTagCard(obj, FormMode.Add);
            form.ShowDialog();
        ...
        private void bNEdit_Click(object sender, EventArgs e)
        {
            ...
            if (id.HasValue)
            {
                ...
                FormTagCard form = new FormTagCard(obj, FormMode.Edit);
                form.ShowDialog();
        ...
        private void bNDelete_Click(object sender, EventArgs e)
        {
            ...
            if (id.HasValue)
            {
                ...
                if (MessageBox.Show(this, "Вы действительно хотите удалить тэг?", "Предупреждение", MessageBoxButtons.OKCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) == System.Windows.Forms.DialogResult.OK)
                {
                    Config.Session.TagUtils.Delete(obj);
                    ApplyFilter();
                }
            }
        }
        ...
        {
            bNView.Enabled = bSList.Current != null;

            bNEdit.Enabled = bSList.Current != null;
            bNDelete.Enabled = bSList.Current != null;
        }
