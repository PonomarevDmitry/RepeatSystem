...
{
    public partial class FormBookList : Form, IFormConfiguration
    {
        ...
        public bool IsSelect
        {
            ...
            set
            {
                ...
                this.KeyDown += new KeyEventHandler(FormBookList_KeyDown);
            }
        }

        void FormBookList_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        public Book SelectedBook { get { return this.selectedBook; } }
        ...
        private bool RefreshList(out DataTable dataTable, out string message)
        {
            ...
            try
            {
                if (Config.Session.BookUtils.GetTable(out dataTable, out message))
                {
                    result = true;
                }
            }
        ...
        private void bNView_Click(object sender, EventArgs e)
        {
            ...
            if (id.HasValue)
            {
                Book obj = Config.Session.BookUtils.GetById(id.Value);

                FormBookCard form = new FormBookCard(obj, FormMode.View);
                form.ShowDialog();
        ...
        private void bNAdd_Click(object sender, EventArgs e)
        {
            ...
            FormBookCard form = new FormBookCard(obj, FormMode.Add);
            form.ShowDialog();
        ...
        private void bNEdit_Click(object sender, EventArgs e)
        {
            ...
            if (id.HasValue)
            {
                ...
                FormBookCard form = new FormBookCard(obj, FormMode.Edit);
                form.ShowDialog();
        ...
        private void bNDelete_Click(object sender, EventArgs e)
        {
            ...
            if (id.HasValue)
            {
                ...
                if (MessageBox.Show(this, "Вы действительно хотите удалить книгу?", "Предупреждение", MessageBoxButtons.OKCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) == System.Windows.Forms.DialogResult.OK)
                {
                    Config.Session.BookUtils.Delete(obj);
                    ApplyFilter();
                }
            }
        }
